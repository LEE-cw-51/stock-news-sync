---
name: 01-frontend-agent
description: Use this agent for frontend UI/UX, Next.js, React, Tailwind CSS tasks. 프론트엔드 컴포넌트, 디자인 시스템, Firebase 클라이언트 구독, 인증 흐름 구현 시 호출.
model: sonnet
color: blue
